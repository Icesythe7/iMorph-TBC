...
enum EUnitFields
{
	...
	UNIT_FIELD_BYTES_0 = OBJECT_END + 0x001E, // Size: 1, Type: BYTES, Flags: PUBLIC //Race
	UNIT_VIRTUAL_ITEM_SLOT_DISPLAY = OBJECT_END + 0x001F, // Size: 3, Type: INT, Flags: PUBLIC //class, gender, powertype
	...
	PLAYER_BYTES = UNIT_END + 0x0005, // Size: 1, Type: BYTES, Flags: PUBLIC <int>PLAYER_BYTES(skin), PLAYER_BYTES(face), PLAYER_BYTES(hairstyle), PLAYER_BYTES(haircolor)
	PLAYER_BYTES_2 = UNIT_END + 0x0006, // Size: 1, Type: BYTES, Flags: PUBLIC <int>PLAYER_BYTE_2(features)		
	...
	PLAYER_VISIBLE_ITEM_16_0 = UNIT_END + 0x0160, // Size: 1, Type: INT, Flags: PUBLIC
	PLAYER_VISIBLE_ITEM_16_1_ENCHANT = UNIT_END + 0x0161, // Size: 1, Type: INT, Flags: PUBLIC
	PLAYER_VISIBLE_ITEM_16_2_TO_11 = UNIT_END + 0x0162, // Size: 10, Type: INT, Flags: PUBLIC
	...
	PLAYER_VISIBLE_ITEM_17_0 = UNIT_END + 0x0170, // Size: 1, Type: INT, Flags: PUBLIC
	PLAYER_VISIBLE_ITEM_17_1_ENCHANT = UNIT_END + 0x0171, // Size: 1, Type: INT, Flags: PUBLIC
	PLAYER_VISIBLE_ITEM_17_2_TO_11 = UNIT_END + 0x0172, // Size: 10, Type: INT, Flags: PUBLIC
